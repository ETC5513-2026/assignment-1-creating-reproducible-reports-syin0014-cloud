...
# can ignore the warning message, cause it will transfer "N/A" to NA
  mutate(signup_date=
  parse_date_time(
...
#The regression results are significant (p-value < 0.001), there are strong positive relationship between marketing spend(x) and purchase amount(y).
